...
player_name_label = tk.Label(playerstats_frame, text="🍴 Hunger:", font="arial")
player_name_label.place(x=window_x_size-735, y=10)
player_name_value_label = tk.Label(playerstats_frame, text=f"{player_main.currency}", font="arial")
player_name_value_label.place(x=window_x_size-645, y=10)
...
working_btn = tk.Button(bottom_frame, text="Arbeiten", command=lambda: get_money(player_main, player_curency_value_label))
working_btn.pack(pady=10)
open_popup(root, player_main, top_frame, player_curency_value_label,player_bottle_value_label)
